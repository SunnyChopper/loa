...
class ProductsController extends Controller
{
    ...
    public function edit_product(Request $data) {
        ...
        if ($data->hasFile('featured_image')) {
            $featured_image = $data->file('featured_image');
        ...
        if ($has_featured_image == true) {
            $file_name = "featured_image." . $featured_image->getClientOriginalExtension();
            $file_path = "products/" . $product_id . "/" . $file_name;
            $featured_image_url = $upload_helper->upload_image_to_s3($featured_image, $file_path);
        }
        ...
        if ($has_featured_image == true) {
            $product_data["featured_image_url"] = $featured_image_url;
        }

        if ($has_extra_image_1 == true) {
            $product_data["image_links"] = json_encode($extra_image_links);
        }

        // Add the product
        $product_helper->edit_product($product_data);
