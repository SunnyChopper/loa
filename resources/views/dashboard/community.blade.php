			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="well">
					...
					<div class="row">
						<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-12 col-12">
							<a href="https://www.facebook.com/groups/1609611142411721/" class="genric-btn primary center-button rounded" style="font-size: 14px;">Join the Group</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="well">
						...
						@if(Auth::guest())
							<p class="text-center mt-16 mb-0">You must be logged in to view voting polls.</p>
						@else
