					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								...
								<input type="text" name="title" value="<?php echo e($post->title); ?>" class="form-control" required>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 mt-16">
							<div class="form-group">
								...
								<textarea name="post_body" form="edit_blog_post_form" id="post_body" class="form-control" rows="16"><?php echo e($post->post_body); ?></textarea>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									...
									<input type="text" name="slug" value="<?php echo e($post->slug); ?>" class="form-control" required>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									...
									<img id="main_image_img" src="<?php echo e($post->featured_image_url); ?>" class="regular-image mb-8 mt-8">
