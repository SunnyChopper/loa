							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
										...
										<input type="text" name="first_name" value="<?php echo e(Auth::user()->first_name); ?>" class="form-control" required>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
										...
										<input type="text" name="last_name" value="<?php echo e(Auth::user()->last_name); ?>" class="form-control" required>
									</div>
								</div>
							</div>
