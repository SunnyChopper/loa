							...
							<tbody>
								<?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td><?php echo e($course_helper->get_views_for_course($course->id)); ?></td>
										<td><?php echo e($course_helper->get_purchased_for_course($course->id)); ?></td>
										<td><?php echo e($course_helper->get_guest_purchases_for_course($course->id)); ?></td>
										<td><?php echo e($course_helper->get_member_purchases_for_course($course->id)); ?></td>
