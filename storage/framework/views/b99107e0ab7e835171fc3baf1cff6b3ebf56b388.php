			...
			<div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-sm-12 col-12">
				<form action="/admin/discussions/update" method="POST" id="update_discussion_form" enctype="multipart/form-data">
					...
					<div class="well">
						<div class="row">
							<div class="col-lg-8 col-md-8 col-sm-12 col-12">
								<div class="form-group">
									...
									<input type="text" name="book_title" class="form-control" value="<?php echo e($book->book_title); ?>" required>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									...
									<input type="text" name="amazon_referral_link" value="<?php echo e($book->amazon_referral_link); ?>" class="form-control">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									...
									<textarea name="book_description" form="update_discussion_form" class="form-control" rows="5"><?php echo e($book->book_description); ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group">
									...
									<input type="date" name="start_date" value="<?php echo e($book->start_date); ?>" class="form-control" required>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group">
									<label>End Date:</label>
									<input type="date" name="end_date" value="<?php echo e($book->end_date); ?>" class="form-control" required>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<img src="<?php echo e($book->book_image_url); ?>" id="book_image" class="regular-image">
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group">
