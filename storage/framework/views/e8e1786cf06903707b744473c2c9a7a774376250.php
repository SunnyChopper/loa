<?php $__env->startSection('content'); ?>
	<?php echo $__env->make('layouts.main-hero', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<?php echo $__env->make('layouts.main-feature', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
					<img src="http://pluspng.com/img-png/forbes-png-recent-press-600.png" class="regular-image">
				</div>
				<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
					<img src="http://pluspng.com/img-png/forbes-png-recent-press-600.png" class="regular-image">
				</div>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<div class="videoWrapper">
					...
					<iframe width="560" height="349" src="http://www.youtube.com/embed/fuCn4VFCCHI?rel=0&hd=1" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<a href="" class="btn primary-btn">Join Wolf Squad</a>
			</div>
		</div>
	</div>

	<div class="dark-blue-row p-32">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
	...
	<div class="container mt-32 mb-32 p-32">
