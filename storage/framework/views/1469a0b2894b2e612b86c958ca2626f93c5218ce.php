<html>
	<head>
        ...
        <link rel="manifest" href="<?php echo e(URL::asset('site.webmanifest')); ?>">
        <link rel="mask-icon" href="<?php echo e(URL::asset('safari-pinned-tab.svg')); ?>" color="#5bbad5">
        ...
        <!-- Social Media -->
        <?php if(isset($seo_data["og_title"])): ?>
            <meta property="og:title" content="<?php echo e($seo_data["og_title"]); ?>">
        <?php else: ?>
            <meta property="og:title" content="Law of Ambition">
        <?php endif; ?>

        <?php if(isset($seo_data["og_description"])): ?>
            <meta property="og:description" content="<?php echo e($seo_data["og_description"]); ?>">
        <?php else: ?>
            <meta property="og:description" content="No sympathy for the lazy.">
        <?php endif; ?>
        
        <?php if(isset($seo_data["og_image"])): ?>
            <meta property="og:image" content="<?php echo e($seo_data["og_image"]); ?>">
        <?php else: ?>
            <meta property="og:image" content="<?php echo e(URL::asset('img/Front-Image.jpg')); ?>">
        <?php endif; ?>

        <?php if(isset($seo_data["og_url"])): ?>
            <meta property="og:url" content="<?php echo e($seo_data["og_url"]); ?>">
        <?php else: ?>
	...
	<body style="display: flex;">
		<div style="display: block; margin: auto;">
			<div class="container">
				<img src="<?php echo e(URL::asset('img/logo.png')); ?>" class="regular-image center-button" style="width: 60%;">
		...
		<script src="<?php echo e(URL::asset('js/vendor/jquery-2.2.4.min.js')); ?>"></script>
